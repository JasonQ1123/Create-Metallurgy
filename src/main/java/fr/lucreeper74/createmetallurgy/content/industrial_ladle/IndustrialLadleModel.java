...
public class IndustrialLadleModel extends CTModel {

    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

    public IndustrialLadleModel(BakedModel originalModel) {
        super(originalModel, new FluidTankCTBehaviour(CMSpriteShifts.INDUSTRIAL_LADLE, CMSpriteShifts.INDUSTRIAL_LADLE_TOP,
